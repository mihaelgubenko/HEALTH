...
class LiteEntityExtractor:
    ...
    def extract_service(text: str) -> Optional[str]:
        ...
        services = {
            'Лечебный массаж для женщин (классический шведский)': ['массаж для женщин', 'женский массаж', 'массаж женщинам'],
            'Лечебный массаж для мужчин (классический шведский)': ['массаж для мужчин', 'мужской массаж', 'массаж мужчинам'],
            'Детский массаж': ['детский массаж', 'массаж детям', 'массаж ребенку'],
            'Массаж грудным детям': ['массаж грудничкам', 'массаж младенцам', 'массаж грудным'],
            'Массаж беременным (от 5 месяцев)': ['массаж беременным', 'беременным массаж', 'для беременных'],
            'Массаж после родов': ['массаж после родов', 'послеродовой массаж'],
            ...
            'Диагностика организма биорезонансным сканированием (базовая)': ['диагностика', 'диагностика организма', 'сканирование', 'биорезонанс', 'диагностика базовая', 'базовая диагностика', 'сканирование базовое'],
            'Диагностика организма биорезонансным сканированием (расширенная)': ['диагностика расширенная', 'расширенная диагностика', 'сканирование расширенное'],
            'Диагностика организма биорезонансным сканированием (VIP)': ['диагностика vip', 'vip диагностика', 'сканирование vip'],
            'Кинезиотейпирование': ['кинезио', 'тейпирование', 'тейпы', 'кинезиотейп'],
            'Подбор комплекса упражнений': ['упражнения', 'комплекс', 'гимнастика', 'лфк']
        }
...
class LiteSmartSecretary:
    ...
    def _handle_normal_flow(self, user_message: str, session_id: str, extracted: Dict) -> Dict[str, Any]:
        ...
        if session.get('awaiting_gender_clarification'):
            if 'мужчина' in user_message_lower or 'мужской' in user_message_lower or 'м' == user_message_lower.strip():
                ...
                entities['service'] = 'Лечебный массаж для мужчин (классический шведский)'
                ...
                entities['service'] = 'Лечебный массаж для женщин (классический шведский)'
                session['awaiting_gender_clarification'] = False
                name = entities.get('name', '')
                return {
    ...
    def _auto_determine_specialist(self, service_name: str) -> Optional[str]:
        ...
        if 'диагностика' in service_lower or 'биорезонанс' in service_lower:
            ...
            # Для массажа специалист определяется по типу услуги
            # Если это женский массаж или массаж для беременных - сразу Екатерина
            if 'женщин' in service_lower or 'беременных' in service_lower:
                return 'Екатерина'
    ...
    def _get_specialists_for_service(self, service_name: str) -> list:
        ...
        service_specialists = {
            'Лечебный массаж для женщин (классический шведский)': ['Екатерина'],
            'Лечебный массаж для мужчин (классический шведский)': ['Авраам'],
            'Лечебный массаж (мужчины) - спортивный': ['Авраам'],
            'Лечебный массаж (мужчины) - лечебный': ['Авраам'],
            'Детский массаж': ['Екатерина'],
            'Массаж грудным детям': ['Екатерина'],
            'Массаж для беременных': ['Екатерина'],
            'Консультация остеопата': ['Екатерина'],
            'Консультация реабилитолога': ['Екатерина'],
            'Консультация нутрициолога': ['Римма'],
            'Диагностика биорезонансным сканированием (базовая)': ['Римма'],
            'Диагностика биорезонансным сканированием (расширенная)': ['Римма'],
            'Диагностика биорезонансным сканированием (VIP)': ['Римма'],
...
Мы свяжемся с вами для подтверждения!"""
    ...
    def _parse_datetime(self, day: str, time: str) -> Optional[datetime]:
        ...
        try:
            ...
            # ИСПРАВЛЕНО: Проверяем, что время в рабочих часах (10:00-19:00)
            if not (10 <= hour < 19):
