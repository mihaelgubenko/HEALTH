...
class LiteEntityExtractor:
    ...
    def extract_service(text: str) -> Optional[str]:
        ...
        # ИСПРАВЛЕНО: Расширенный словарь всех услуг из БД
        services = {
            ...
            'Массаж детский': ['детский массаж', 'массаж детям', 'массаж ребенку'],
            ...
            'Массаж после родов': ['массаж после родов', 'после родов массаж', 'послеродовой'],
            ...
            'Диагностика организма биорезонансным сканированием (базовая)': ['диагностика базовая', 'базовая диагностика', 'сканирование базовое'],
...
class LiteSmartSecretary:
    ...
    def _get_specialists_for_service(self, service_name: str) -> list:
        ...
        # Маппинг услуг на специалистов
        service_specialists = {
            'Лечебный массаж для женщин (классический шведский)': ['Авраам'],
            'Лечебный массаж для мужчин (классический шведский)': ['Авраам'],
            'Массаж детский': ['Авраам'],
            'Массаж грудным детям': ['Авраам'],
            'Массаж беременным (от 5 месяцев)': ['Авраам'],
            'Массаж после родов': ['Авраам'],
            'Консультация остеопата': ['Екатерина'],
            'Консультация реабилитолога': ['Екатерина'],
            'Консультация нутрициолога': ['Римма'],
            'Диагностика организма биорезонансным сканированием (базовая)': ['Екатерина'],
            'Диагностика организма биорезонансным сканированием (расширенная)': ['Екатерина'],
            'Диагностика организма биорезонансным сканированием (VIP)': ['Екатерина'],
            'Кинезиотейпирование': ['Екатерина'],
            'Подбор комплекса упражнений': ['Екатерина']
        }
