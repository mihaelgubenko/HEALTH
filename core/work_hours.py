...
class WorkHours:
    ...
    # None - не работаем
    SCHEDULE = {
        0: (9, 19),   # Понедельник: 09:00 - 19:00
        1: (9, 19),   # Вторник: 09:00 - 19:00
        2: (9, 19),   # Среда: 09:00 - 19:00
        3: (9, 19),   # Четверг: 09:00 - 19:00
        4: (9, 19),   # Пятница: 09:00 - 19:00 (по договоренности)
        5: None,      # Суббота: Не работаем
        6: (10, 16),  # Воскресенье: 10:00 - 16:00
    }
    ...
    def get_schedule_text(cls) -> str:
        ...
        return """🕐 Часы работы:
• Пн-Чт: 09:00-19:00
• Пт: 09:00-19:00 (по договоренности)
• Сб: Не работаем
• Вс: 10:00-16:00"""
    ...
    def get_schedule_html(cls) -> str:
        ...
        <div class="work-hours">
            <p><strong>Понедельник - Четверг:</strong> 09:00 - 19:00</p>
            <p><strong>Пятница:</strong> 09:00 - 19:00 (по договоренности)</p>
